...
# ADD CPP /nologo /MD /W3 /Zi /O2 /I "..\common" /I "$(NS_HOME)\plugins\include" /I "$(JAVA_HOME)\include" /I "$(JAVA_HOME)\include\win32" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "NSAPI_EXPORTS" /D "XP_WIN32" /Fd"Release/nsapi_redirect_src" /FD /c
...
# ADD LINK32 wsock32.lib ns-httpd36.lib /nologo /base:"0x6A6B0000" /dll /machine:I386 /out:"Release/nsapi_redirect.dll" /libpath:"$(NS_HOME)\plugins\lib"
...
# ADD LINK32 wsock32.lib ns-httpd36.lib /nologo /base:"0x6A6B0000" /dll /debug /machine:I386 /out:"Debug/nsapi_redirect.dll" /pdbtype:sept /libpath:"$(NS_HOME)\lib"
# SUBTRACT LINK32 /pdb:none
